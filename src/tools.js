...
const LOCATIONS = {
  ...
  'CtJXgSUBktpXEKMo98B9': { name: 'Restore Brain', apiKey: 'pit-a1efdf61-6270-4e0e-b519-86b982aab3a0' },
  'k9ibvDvqOEuYtb9fyv7Y': { name: 'Innovative Psychedelics', apiKey: 'pit-8e26e9a5-a8c7-4ad9-bf62-55903a5468f1' },
  'xzuDuEmvvnZ4FLQXo3ky': { name: 'Flagstaff Ketamine & TMS', apiKey: 'pit-312535f2-579c-40b7-907e-b41612a98efd' },
  'BGwlMguBoSy0QHMC3gRN': { name: 'Hawaii Ketamine', apiKey: 'pit-d02b2b33-2101-4bee-8c66-d33333dc01f2' },
  'aQrCsWpc98WDVvV3OlmA': { name: 'Restorativ Wellness', apiKey: 'pit-3b321198-824d-463c-ac7b-7fd778d07dd8' },
  'OC5gKXFr9TmcQsxvsKuB': { name: 'Ketalink', apiKey: 'pit-2797829c-4bbc-43a0-89c3-c59a8da7b53f' },
  'JQ7yC48jSyebTRoZpJ56': { name: 'Allied Healthcare', apiKey: 'pit-2f2f4a7c-6069-4629-802a-d15cc2b8b135' },
  'GPDtlksy1EmnPV21kUbg': { name: 'Path to Awareness', apiKey: 'pit-bfd0004e-8821-4a78-8d21-cbcad8392a65' },
  'BSyc6rBZ2yejgrcayya4': { name: 'Learning to Achieve Wellness', apiKey: 'pit-4e798546-2041-403e-a976-31c9cd38240d' },
  '9nDtz7wV8EdhFSAiqKse': { name: 'Visionary Psychiatry', apiKey: 'pit-466766e8-751d-49cf-8b61-53b40b0c173f' },
  'FSaanEpP3nyPYrXWi0mg': { name: 'Wound Access', apiKey: 'pit-39852e95-b669-4af8-ac96-ae3f2a056afe' },
  'nsZeg0t6Y4DZP4hOkqH8': { name: 'Etherios Therapy', apiKey: 'pit-f8655d9d-9200-4d75-93bb-d616b56c6277' },
  'hpd856CzIPDFTlIfhXfa': { name: 'Progeny TMS', apiKey: 'pit-bc53ed21-f4f3-40a7-bdb8-9d1fe1b6143a' },
  'e4r9nkKeOgXPZycccNZ9': { name: 'TMS Revitalizes', apiKey: 'pit-3a8c5cba-140c-4997-9aff-83ae5b747b50' },
  'yGjbgUEezuT7LsFMtRpq': { name: 'Hudson Mind', apiKey: 'pit-6b142cac-70ec-46c9-ad81-cda8bd59139e' },
  'tLySAoxG7yfVq6FC9BkL': { name: 'Chicago Wound', apiKey: 'pit-d965ef13-6716-4547-ac44-af25c4bf1492' },
  'FwaFsUmAiI6shBERCLHZ': { name: 'Mend Psychiatry', apiKey: 'pit-1fdc2ee4-31e0-4f3c-9991-374ebde8189d' },
  'uqU1V6apBkBXU299oIVA': { name: 'Novara Healthcare', apiKey: 'pit-9c97b10d-cdbc-4679-9a60-9419770b9745' },
};
...
function createServer() {
  ...
  t('ghl_get_opportunities', {
    pipelineId: z.string().optional(),
    stageId: z.string().optional(),
    status: z.string().optional().describe("Filter by status: 'open', 'won', 'lost', 'abandoned', or 'all'."),
    startDate: z.string().optional().describe('MM-DD-YYYY. Filters by updatedAt >= startDate.'),
    endDate: z.string().optional().describe('MM-DD-YYYY. Applied client-side when fetchAll=true.'),
    limit: z.number().optional().describe('Records per page (GHL max: 100). Default 100.'),
    startAfter: z.number().optional().describe('Pagination cursor: updatedAt ms from prior meta.startAfter.'),
    startAfterId: z.string().optional().describe('Pagination cursor: opportunity id from prior meta.startAfterId.'),
    fetchAll: z.boolean().optional().describe('If true, paginate through every page and return combined result. Default false.'),
    maxPages: z.number().optional().describe('Safety cap when fetchAll=true. Default 20 (up to 2,000 records).'),
    locationId: loc,
  }, (a) => handleTool('ghl_get_opportunities', a));
